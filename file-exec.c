...
error_t
S_file_exec (struct protid *pi, task_t task, int flags,
...
{
  return S_file_exec_paths (pi, task, flags, "", "",
                            argv, argvlen, envp, envplen,
                            fds, fdslen, portarray,
                            portarraylen, intarray,
                            intarraylen, deallocnames,
                            deallocnameslen, destroynames,
                            destroynameslen);
}
